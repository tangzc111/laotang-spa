		...
		<div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4'>
			...
			<div className='max-w-6xl mx-auto'>
				<div className='text-center mb-16 animate-fade-in'>
					...
					<p className='text-xl text-gray-600 max-w-2xl mx-auto'>探索 Tailwind CSS 的强大功能与精美设计</p>
				</div>
				...
				<div className='bg-white rounded-3xl shadow-2xl p-8 mb-16'>
					<h2 className='text-3xl font-bold text-gray-900 mb-6 text-center'>交互式计数器</h2>
				...
				<div className='bg-white rounded-3xl shadow-2xl p-8'>
					<h2 className='text-3xl font-bold text-gray-900 mb-6 text-center'>自定义调色板</h2>
							...
							<div className='grid grid-cols-5 md:grid-cols-9 gap-2'>
								{[
									...
									<div key={shade} className='text-center'>
										<div className={`w-full h-16 rounded-lg ${className} shadow-md mb-1`} />
				...
				<div className='text-center mt-16 text-gray-600'>
					<p className='text-sm'>使用 Tailwind CSS 4.x 构建 • 配置文件：tailwind.config.js</p>
				</div>
			</div>
		</div>
	);
